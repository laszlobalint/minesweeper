...
const blocktile = require("./modules/blocktile");
  ...
  switch (difficultyLevel) {
    case 0:
      ...
      while (loop === true) {
        ...
        movement(8, 9, 10, "./scores/topEasy.txt", 11);
      }
    ...
    case 1:
      ...
      while (loop === true) {
        ...
        movement(16, 17, 40, "./scores/topMedium.txt", 17);
      }
    ...
    case 2:
      ...
      while (loop === true) {
        ...
        movement(22, 23, 99, "./scores/topHard.txt", 23);
      }
      break;
  }
}
